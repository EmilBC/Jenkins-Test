...
dockerImageTag = "devopsexamplenew${env.BUILD_NUMBER}"
   ...
   stage('Initialize Docker'){    
    ...
    stage('Build Docker Image') {
	    steps{
      sh "docker -H  tcp://2.tcp.eu.ngrok.io:16232 build -t devopsexamplenew1234:${env.BUILD_NUMBER} ."
	    }
    }
	...
	sh "docker -H  tcp://2.tcp.eu.ngrok.io:16232 run --name devopsexamplenew1234 -d -p 5556:5556 devopsexamplenew1234:${env.BUILD_NUMBER}"
	    }
    }
    }
